...
6. [Discovery of DECLARE models from event logs](https://github.com/ivanDonadello/Declare4Py/blob/main/docs/source/tutorials/6.Declare_Model_Discovery.ipynb): discover what are the most satisfied DECLARE constraints in an event log;
   6.1 [Discovery of DECLARE models from text](https://github.com/ivanDonadello/Declare4Py/blob/main/docs/source/tutorials/6.1.Textual_Declare_Model_Discovery.ipynb): discover a DECLARE model from text specification with the use of Large Language Models.
